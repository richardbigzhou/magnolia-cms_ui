...
public class WebkitFrameEventHandler extends AbstractFrameEventHandler {
    ...
    private final native void addIframeTouchMoveListener(Document doc, Element cont) /*-{
        ...
        doc.body.addEventListener('touchmove',
                function(event) {
                    that.@info.magnolia.ui.widget.editor.gwt.client.jsni.WebkitFrameEventHandler::touchScrolling = true;
                    ...
                    that.@info.magnolia.ui.widget.editor.gwt.client.jsni.WebkitFrameEventHandler::lastY = cont.scrollTop;
        ...
        doc.body.addEventListener('touchstart',
                function (event) {
                    that.@info.magnolia.ui.widget.editor.gwt.client.jsni.WebkitFrameEventHandler::touchScrolling = false;
    ...
    public native void initNativeTouchSelectionListener(Element element, VPageEditorView.Listener listener) /*-{
        if (element != 'undefined') {
            ...
            element.contentDocument.ontouchend = function(event) {
                var isTouchScrolling = ref.@info.magnolia.ui.widget.editor.gwt.client.jsni.WebkitFrameEventHandler::isTouchScrolling()();
                if (!isTouchScrolling) {
                    that.@info.magnolia.ui.widget.editor.gwt.client.VPageEditor::selectElement(Lcom/google/gwt/dom/client/Element;)(event.target);
                    ref.@info.magnolia.ui.widget.editor.gwt.client.jsni.WebkitFrameEventHandler::resetScrollTop()();
                }
            }
        }
    }-*/;
