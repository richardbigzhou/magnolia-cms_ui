...
/**
 * Vaadin UI component that displays a tree with auto-suggest.
 */
public class AutoSuggestTreeViewImpl extends TreeViewImpl implements AutoSuggestTreeView {

    private AutoSuggestMagnoliaTreeTable tree = null;
    private AutoSuggestInplaceEditingFieldFactory fieldFactory = null;
    private AutoSuggester autoSuggester = null;

    @Override
    protected TreeTable createTable(com.vaadin.data.Container container) {
        this.tree = new AutoSuggestMagnoliaTreeTable(container);
        return this.tree;
    }

    @Override
    protected InplaceEditingFieldFactory createInplaceEditingFieldFactory() {
        this.fieldFactory = new AutoSuggestInplaceEditingFieldFactory();
