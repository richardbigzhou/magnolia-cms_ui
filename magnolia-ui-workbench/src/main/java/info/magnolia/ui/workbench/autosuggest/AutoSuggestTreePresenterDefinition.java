...
/**
 * Configured definition for a content view presenting a tree with auto-suggest.
 */
public class AutoSuggestTreePresenterDefinition extends TreePresenterDefinition {

    private Class<? extends AutoSuggester> autoSuggesterClass;

    public AutoSuggestTreePresenterDefinition() {
        super();
        setImplementationClass(AutoSuggestTreePresenter.class);
    }
