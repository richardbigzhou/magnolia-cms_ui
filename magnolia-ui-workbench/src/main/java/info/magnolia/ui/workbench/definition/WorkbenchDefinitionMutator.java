...
/**
 * Takes an instance of {@link WorkbenchDefinition} provided by the {@link info.magnolia.config.MutableWrapper} utility,
...
public class WorkbenchDefinitionMutator extends Mutator<WorkbenchDefinition> {
    ...
    public WorkbenchDefinitionMutator setDialogWorkbench(boolean dialogWorkbench) {
        setProperty("dialogWorkbench", dialogWorkbench);
        return this;
    }

    public WorkbenchDefinitionMutator setEditable(boolean editable) {
