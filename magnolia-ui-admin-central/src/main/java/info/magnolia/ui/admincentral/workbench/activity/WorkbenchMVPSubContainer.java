...
public class WorkbenchMVPSubContainer extends AbstractMVPSubContainer<WorkbenchActivity>{
    ...
    protected ComponentProviderConfiguration configureComponentProvider() {
        ...
        ComponentProviderConfiguration componentProviderConfiguration =  new ComponentProviderConfiguration();//FIXME fgrillidefaultComponentsConfiguration.clone();
    ...
    protected Class<? extends Place>[] getSupportedPlaces() {
        ...
        return new Class[] {ItemSelectedPlace.class, SearchPlace.class};
    }
