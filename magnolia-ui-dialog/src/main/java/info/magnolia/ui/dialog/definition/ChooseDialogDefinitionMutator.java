...
/**
 * Takes an instance of {@link ChooseDialogDefinition} provided by the {@link info.magnolia.config.MutableWrapper} utility,
 * and exposes setter methods wired dynamically via {@link info.magnolia.config.MutableWrapper.Mutable} interface.
 */
public class ChooseDialogDefinitionMutator extends Mutator<ChooseDialogDefinition> {
    ...
    public ChooseDialogDefinitionMutator setField(FieldDefinition field) {
        setProperty("field", field);
        return this;
    }

    public ChooseDialogDefinitionMutator setContentConnector(ContentConnectorDefinition contentConnector) {
        setProperty("contentConnector", contentConnector);
        return this;
    }
}
