...
public class EditorActionAreaPresenterImplTest {
    ...
    public void makeSureSecondaryActionsAreAddedToCorrectArea() {
        ...
        final List<ActionDefinition> actions = Lists.newArrayList(primaryAction, secondaryAction);
        final List<SecondaryActionDefinition> secondaryActions = Lists.newArrayList(new SecondaryActionDefinition(secondaryActionName));
