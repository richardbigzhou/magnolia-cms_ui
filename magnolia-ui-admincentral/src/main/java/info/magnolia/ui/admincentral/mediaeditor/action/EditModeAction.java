...
import info.magnolia.ui.admincentral.mediaeditor.editmode.EditModeBuilder;
...
public class EditModeAction extends ActionBase<EditModeActionDefinition> {
    ...
    public EditModeAction(BaseDialog dialog, EditModeActionDefinition definition, EditModeBuilderFactory builderFactory) {
        super(definition);
        this.dialog = dialog;
    ...
    public void execute() throws ActionExecutionException {
        ...
        dialog.setContent(builder.createMediaField());
    }
}
