...
/**
 * This rule returns true if the task status is created.
 */
public final class CanClaimTaskRule extends AbstractTaskStatusRule {

    @Inject
    public CanClaimTaskRule(TasksStore store) {
        super(store);
    }
