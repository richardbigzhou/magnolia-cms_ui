...
/**
 * This rule returns true if the task status is in progress.
 */
public final class CanProceedTaskRule extends AbstractTaskStatusRule {

    @Inject
    public CanProceedTaskRule(TasksStore store) {
        super(store);
    }
