...
public class AdmincentralModuleVersionHandler extends DefaultModuleVersionHandler {
    ...
    public AdmincentralModuleVersionHandler() {
        ...
        register(DeltaBuilder.update("5.1", "")
                ...
                .addTask(new NodeExistsDelegateTask("Name","Description", RepositoryConstants.CONFIG,"/modules/ui-framework/config/appLauncherLayout",new MoveNodeTask("Move configuration of the appLauncherLayout from the ui-framework to the ui-admincentral", "Moves the the conf. of the appLauncherLayout from the ui-framework to the ui-admincentral", RepositoryConstants.CONFIG, "/modules/ui-framework/config/appLauncherLayout", "/modules/ui-admincentral/config/appLauncherLayout", false)))
                //.addTask(new MoveNodeTask("Move configuration of the appLauncherLayout from the ui-framework to the ui-admincentral", "Moves the the conf. of the appLauncherLayout from the ui-framework to the ui-admincentral", RepositoryConstants.CONFIG, "/modules/ui-framework/config/appLauncherLayout", "/modules/ui-admincentral/config/appLauncherLayout", false))
