...
public class AppEventTest {
    ...
    // ArrayList<ModuleDefinition> moduleDefinitions = new
    ...
    // mock(AppDescriptorRegistry.class);
    //
    // appController = new AppControllerImpl(moduleRegistry, componentProvider,
    // appLauncherLayoutManager, locationController, messagesManager, shell,
    // eventBus);
    // }
    //
    // @After
    ...
    // handler
    // appController.startIfNotAlreadyRunningThenFocus(appName, new
    // DefaultLocation(Location.LOCATION_TYPE_APP, appName, "", ""));
    //
    // // Initial check
    ...
    // AppEventTestImpl firstAppInstance = (AppEventTestImpl)
    // AppTestImpl.res.get("TestPageApp0");
    // EventBus firstInstanceBus = firstAppInstance.eventBus;
    // InvocationCountingTestEventHandler firstInstanceHandler =
    // firstAppInstance.handler;
    //
    ...
    // AppEventTestImpl secondAppInstance = (AppEventTestImpl)
    // AppTestImpl.res.get("TestPageApp1");
    // EventBus secondInstanceBus = secondAppInstance.eventBus;
    // InvocationCountingTestEventHandler secondInstanceHandler =
    // secondAppInstance.handler;
    //
    // // WHEN
    // // Send Event to this Bus
    ...
    // // create subapps
    // Map<String, SubAppDescriptor> subApps = new HashMap<String,
    // SubAppDescriptor>();
    // subApps.put(subAppName_1,
    // AppTestUtility.createSubAppDescriptor(subAppName_1, AppTestSubApp.class,
    // true));
    //
    // // Set cat1 with App1
