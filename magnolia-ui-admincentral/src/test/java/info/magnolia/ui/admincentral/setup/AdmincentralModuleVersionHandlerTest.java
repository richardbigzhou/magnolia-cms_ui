...
public class AdmincentralModuleVersionHandlerTest extends ModuleVersionHandlerTestCase {
    ...
    public void updateFrom54JcrToYamlExport() throws Exception {
        ...
        NodeUtil.createPath(session.getRootNode(), "/modules/ui-admincentral/apps/configuration/subApps/browser/actionbar/sections/folders/groups/importExportActions", NodeTypes.ContentNode.NAME);

        // WHEN
        executeUpdatesAsIfTheCurrentlyInstalledVersionWas(Version.parseVersion("5.4"));

        // THEN
        assertThat(session.getRootNode(), hasNode("modules/ui-admincentral/commands/default/exportYaml"));
