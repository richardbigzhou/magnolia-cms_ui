...
public class AdmincentralModuleVersionHandlerTest extends ModuleVersionHandlerTestCase {
    ...
    @Test
    public void testUpdateTo531DoesNotAddAutoSuggestToConfigurationAppWhenNoTreePresenterClass() throws Exception {
        // GIVEN
    ...
    @Test
    public void testUpdateTo531AddsAutoSuggestToConfigurationApp() throws Exception {
        // GIVEN
    ...
    @Test
    public void testUpdateTo531DoesNotAddAutoSuggestToConfigurationAppWhenTreePresenterClassHasUnexpectedValue() throws Exception {
        // GIVEN
    ...
    @Test
    public void testUpdateTo531DoesNotAddAutoSuggestToConfigurationAppWhenAutoSuggesterClassExists() throws Exception {
        // GIVEN
        setupConfigProperty("modules/ui-admincentral/apps/configuration/subApps/browser/workbench/contentViews/tree", "class", "info.magnolia.ui.workbench.tree.TreePresenterDefinition");
    ...
    @Test
    public void testUpdateTo531AddsAddDefinitionActionToConfigurationApp() throws Exception {
        // GIVEN
