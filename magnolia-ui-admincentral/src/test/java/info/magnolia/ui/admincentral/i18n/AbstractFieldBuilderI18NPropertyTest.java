...
/**
 * Main testcase for {@link info.magnolia.ui.form.field.builder.AbstractFieldBuilder} i18n property.
 */
public class AbstractFieldBuilderI18NPropertyTest extends AbstractBuilderTest<ConfiguredFieldDefinition> {
    ...
    protected void initBuilder() {
        abstractDialogField = new AbstractFieldBuilderTest.TestTextFieldBuilder(definition, baseItem);
        ...
        abstractDialogField.setComponentProvider(cc);
    }
