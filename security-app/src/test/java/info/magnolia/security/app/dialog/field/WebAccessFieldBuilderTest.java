...
/**
 * Test case for {@link info.magnolia.security.app.dialog.field.WebAccessFieldBuilder}.
 */
public class WebAccessFieldBuilderTest extends MgnlTestCase {
    ...
    public void testShowsAddButtonAndEmptyLabelWhenEmpty() {
        ...
        WebAccessFieldBuilder builder = new WebAccessFieldBuilder(definition, item);

        // WHEN
        Field<Object> field = builder.buildField();
    ...
    public void testShowsAclEntryFromRepository() throws IOException, RepositoryException {
        ...
        WebAccessFieldDefinition definition = new WebAccessFieldDefinition();
        WebAccessFieldBuilder builder = new WebAccessFieldBuilder<WebAccessFieldDefinition>(definition, item);
