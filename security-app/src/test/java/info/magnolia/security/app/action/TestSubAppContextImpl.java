...
/**
 * Test uiContext that automatically call callback.onSuccess() if confirmation is needed
 */
public class TestSubAppContextImpl extends SubAppContextImpl {

    public TestSubAppContextImpl(SubAppDescriptor subAppDescriptor, Shell shell) {
        super(subAppDescriptor, shell);
    }
