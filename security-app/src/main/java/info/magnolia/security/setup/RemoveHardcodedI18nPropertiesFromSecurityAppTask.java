...
public class RemoveHardcodedI18nPropertiesFromSecurityAppTask extends AbstractRemoveHardcodedI18nPropertiesTask {
    ...
    public RemoveHardcodedI18nPropertiesFromSecurityAppTask(final String appName) {
        super(appName, "Removes hardcoded i18n properties from security-app. This will typically affect properties found in actions, actionbar and workbench.");
    }
