...
public class JQueryWrapper extends JavaScriptObject {
    ...
    public final native void animate(int duration, AnimationSettings settings) /*-{
        var json = settings.@org.vaadin.addon.jquerywrapper.client.ui.AnimationSettings::asJSO()();
        var jq = this;
        this.animate(json, duration, function() {
            if (settings != null) {
                settings.@org.vaadin.addon.jquerywrapper.client.ui.AnimationSettings::getCallbacks()().fire(jq);
            }
        });
    }-*/;
    ...
    public final native Integer cssInt(final String property) /*-{ 
        ...
        return @org.vaadin.addon.jquerywrapper.client.ui.JQueryWrapper::parseInt(Ljava/lang/String;)(result);
    }-*/;
