...
public class RestoreVersionActionTest extends RepositoryTestCase {
    ...
    public void restorePageWithVariantsDoesNotFailOnException() throws Exception {
        ...
        MockRestoreVersionAction restoreVersionAction = new MockRestoreVersionAction(definition, null, null, uiContext, formDialogPresenter, new JcrNodeAdapter(root), i18n, versionManager, eventBus, versionConfig);
