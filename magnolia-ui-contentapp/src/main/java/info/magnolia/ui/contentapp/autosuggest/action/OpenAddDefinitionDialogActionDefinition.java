...
/**
 * Definition for {@link OpenAddDefinitionDialogAction}.
 */
public class OpenAddDefinitionDialogActionDefinition extends ConfiguredActionDefinition {

    private Class<? extends AutoSuggester> autoSuggesterClass;

    public OpenAddDefinitionDialogActionDefinition() {
        setImplementationClass(OpenAddDefinitionDialogAction.class);
    }
