...
/**
 * Definition for {@link AddDefinitionAvailabilityRule}.
 */
public class AddDefinitionAvailabilityRuleDefinition extends ConfiguredAvailabilityRuleDefinition {

    private Class<? extends AutoSuggester> autoSuggesterClass;

    public AddDefinitionAvailabilityRuleDefinition() {
        this.setImplementationClass(AddDefinitionAvailabilityRule.class);
    }
