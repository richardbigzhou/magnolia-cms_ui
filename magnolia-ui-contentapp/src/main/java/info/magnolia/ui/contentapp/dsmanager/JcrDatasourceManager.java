 ...
 */
public class JcrDataSourceManager implements DataSourceManager {

    private Logger log = LoggerFactory.getLogger(getClass());

    private AppDescriptor appDescriptor;

    public JcrDataSourceManager(AppDescriptor appDescriptor) {
    ...
    public Item getItemById(Object itemId) {
        ...
        try {
            ...
            log.error("Failed to find item for id", e.getMessage());
            return null;
        }
    }
    ...
    private WorkbenchDefinition getWorkbenchDefinition() {
        for (SubAppDescriptor subAppDescriptor : appDescriptor.getSubApps().values()) {
