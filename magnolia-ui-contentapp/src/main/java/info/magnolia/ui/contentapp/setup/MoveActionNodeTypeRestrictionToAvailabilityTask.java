...
public class MoveActionNodeTypeRestrictionToAvailabilityTask extends QueryTask {
    ...
    @Inject
    public MoveActionNodeTypeRestrictionToAvailabilityTask(Class<? extends ActionDefinition>... actionsToMigrateClasses) {
        super(
              ...
              RepositoryConstants.CONFIG, constructQuery(actionsToMigrateClasses));
    }

    private static String constructQuery(Class<? extends ActionDefinition>[] actionsToMigrateClasses) {
