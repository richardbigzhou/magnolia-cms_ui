...
public class BasicTransformer<T> implements Transformer<T> {
    ...
    /**
     * @deprecated since 5.4.1 - should not be used any longer, alter {@link #basePropertyName} in {@link #setLocale(Locale)} method if needed.
     */
    @Deprecated
    ...
    /**
     * @deprecated since 5.4.1 - use {@link #BasicTransformer(Item, ConfiguredFieldDefinition, Class, I18NAuthoringSupport)} instead.
     */
    @Deprecated
    ...
    public void setI18NPropertyName(String i18nPropertyName) {
        log.warn("BasicTransformer.setI18NPropertyName() is deprecated since 5.4.1 without replacement, override BasicTransformer.definePropertyName() and construct the locale-specific property name there if needed.");
    }
