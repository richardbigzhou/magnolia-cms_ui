...
/**
 * Simple {@link PropertyHandler} implementation that store/retrieve the properties contained in a {@link PropertysetItem} as a sub Item (equivalent to a Child Node).<br>
...
public class SubNodesCompositeHandler extends AbstractBaseHandler<PropertysetItem> implements PropertyHandler<PropertysetItem> {
    ...
    @Inject
    public SubNodesCompositeHandler(Item parent, ConfiguredFieldDefinition definition, ComponentProvider componentProvider, List<String> fieldsName) {
