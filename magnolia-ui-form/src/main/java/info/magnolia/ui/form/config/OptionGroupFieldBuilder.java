...
public class OptionGroupFieldBuilder extends SelectFieldBuilder {
    ...
    @Override
    protected OptionGroupFieldDefinition getDefinition() {
    ...
    public OptionGroupFieldBuilder multiselect(boolean multiselect) {
        getDefinition().setMultiselect(multiselect);
        return this;
    }
    ...
    @Override
    public OptionGroupFieldBuilder valueNodeData(String valueNodeData) {
        return (OptionGroupFieldBuilder) super.valueNodeData(valueNodeData);
    }

    @Override
    public OptionGroupFieldBuilder labelNodeData(String labelNodeData) {
        return (OptionGroupFieldBuilder) super.labelNodeData(labelNodeData);
    }
