 ...
 */
public class EmailFieldValidatorFactory extends AbstractFieldValidatorFactory<EmailValidatorDefinition> {

    public EmailFieldValidatorFactory(EmailValidatorDefinition definition) {
        super(definition);
    }
