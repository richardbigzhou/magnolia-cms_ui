...
public class DelegatingMultiValueFieldTransformer extends BasicTransformer<PropertysetItem> implements MultiTransformer {
     ...
     * <p>
     * By default, we use the {@link FieldDefinition#getName()}.
     */
     ...
     * <ul>
     * <li><i>subItemBaseName</i> can be set via {@link #setSubItemBaseName()}; by default we use the {@link FieldDefinition#getName()}
