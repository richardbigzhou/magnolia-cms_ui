 ...
 * .
 */
public class SimplePropertyCompositeHandlerTest extends RepositoryTestCase {
    ...
    public void setUp() throws Exception {
        ...
        String nodeProperties =
                "/parent.@type=mgnl:content\n" +
                        "/parent.fieldName_field2=hello2\n";
    ...
    public void testWriteMultiProperty() throws RepositoryException {
        ...
        SimplePropertyCompositeHandler delegate = new SimplePropertyCompositeHandler(parent, definition, new MockComponentProvider(), fieldsName);
        ...
        // THEN
        assertTrue(rootNode.hasProperty("fieldName_field1"));
        assertEquals("hello1", rootNode.getProperty("fieldName_field1").getString());
        assertTrue(rootNode.hasProperty("fieldName_field2"));
        assertEquals("hello2", rootNode.getProperty("fieldName_field2").getString());
    }
    ...
    public void testReadWriteMultiProperty() throws RepositoryException {
        ...
        assertTrue(rootNode.hasProperty("fieldName_field1"));
        assertEquals("hello1", rootNode.getProperty("fieldName_field1").getString());
        assertFalse(rootNode.hasProperty("fieldName_field2"));
    }
