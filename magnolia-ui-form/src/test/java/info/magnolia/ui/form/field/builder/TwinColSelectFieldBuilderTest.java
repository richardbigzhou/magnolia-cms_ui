...
/**
 * Main testcase for {@link info.magnolia.ui.form.field.builder.TwinColSelectFieldBuilder}.
 */
public class TwinColSelectFieldBuilderTest extends AbstractBuilderTest<TwinColSelectFieldDefinition> {
    ...
    public void simpleTwinColFieldTest() throws Exception {
        ...
        // WHEN
        Field field = twinSelect.getField();
