...
import info.magnolia.ui.vaadin.integration.widget.client.grid.VMagnoliaTreeTable.VTreeTableScrollBody.VTreeTableRow;
 ...
 * VMagnoliaTreeTable.
 */
public class VMagnoliaTreeTable extends VMagnoliaTable {
    ...
    private LinkedList<PendingNavigationEvent> pendingNavigationEvents = new LinkedList<VMagnoliaTreeTable.PendingNavigationEvent>();
    private boolean focusParentResponsePending;

    /**
     * FocusableScrollPanel inces is changed as now the first logical widget of the table is select all checkbox.
     */
    @Override
