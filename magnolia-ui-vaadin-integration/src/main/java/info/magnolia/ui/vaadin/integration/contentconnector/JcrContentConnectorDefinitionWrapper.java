...
/**
 * Delegating wrapper around {@link JcrContentConnectorDefinition}. Helps with creation of dynamically modifiable content connector
 * definitions at the same time avoiding modifications of a 'singleton' delegate definition.
 */
public class JcrContentConnectorDefinitionWrapper implements JcrContentConnectorDefinition {
    ...
    public JcrContentConnectorDefinitionWrapper(JcrContentConnectorDefinition delegate) {
    ...
    public void setDelegate(JcrContentConnectorDefinition delegate) {
