...
/**
 * Takes an instance of {@link JcrContentConnectorDefinition} provided by the {@link info.magnolia.config.MutableWrapper} utility,
...
public class JcrContentConnectorDefinitionMutator extends Mutator<JcrContentConnectorDefinition> {
    ...
    JcrContentConnectorDefinitionMutator(JcrContentConnectorDefinition mutableObject) {
        super(mutableObject);
    }

    public JcrContentConnectorDefinitionMutator setRootPath(String rootPath) {
