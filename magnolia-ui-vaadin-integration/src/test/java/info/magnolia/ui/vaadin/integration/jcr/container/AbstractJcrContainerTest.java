...
public class AbstractJcrContainerTest extends RepositoryTestCase{
    ...
    public void setUp() throws Exception{
        ...
        mainItemType.setItemType(MgnlNodeTypeNames.CONTENT);
    ...
    public void testGetItem() throws Exception {
        // GIVEN
        final Node node1 = createNode(rootNode, "node1", MgnlNodeTypeNames.CONTENT, "name", "name1");
    ...
    public void testNextItemId() throws Exception {
        // GIVEN
        Node node1 = createNode(rootNode, "node1", MgnlNodeTypeNames.CONTENT, "name", "name1");
        Node node2 = createNode(rootNode, "node2", MgnlNodeTypeNames.CONTENT, "name", "name2");
        node1.getSession().save();
    ...
    public void testFirstItemId() throws Exception {
        // GIVEN
        Node node1 = createNode(rootNode, "node1", MgnlNodeTypeNames.CONTENT, "name", "name1");
        createNode(rootNode, "node2", MgnlNodeTypeNames.CONTENT, "name", "name2");
        node1.getSession().save();
        String containerItemId1 = node1.getPath();
        setSorter("name",true);
        jcrContainer.getItem(containerItemId1);
    ...
    public void testLastItemId() throws Exception {
        // GIVEN
        final Node node1 = createNode(rootNode, "node1", MgnlNodeTypeNames.CONTENT, "name", "name1");
        final Node node2 = createNode(rootNode, "node2", MgnlNodeTypeNames.CONTENT, "name", "name2");
        node1.getSession().save();
    ...
    public void testAddItem() throws Exception {
        // GIVEN
        Node node1 = rootNode.addNode("node1",MgnlNodeTypeNames.CONTENT);
    ...
    public void testOffestIsResetAfterSort() throws Exception {
        ...
        Node node1 = createNode(rootNode, "node0", MgnlNodeTypeNames.CONTENT, "name", "name0");
        for (int i = 1; i <= 5; i++) {
            createNode(rootNode, "node" + i, MgnlNodeTypeNames.CONTENT, "name", "name" + i);
        }
        node1.getSession().save();
    ...
    public void testContainsId() throws Exception{
        ...
        final Node node1 = createNode(rootNode, existingKey, MgnlNodeTypeNames.CONTENT, "name", "name1");
        node1.getSession().save();
    ...
    public void testConstructJCRQueryWithoutSort() {
        ...
        // THEN
        assertEquals(String.format(AbstractJcrContainer.SELECT_TEMPLATE, MgnlNodeTypeNames.CONTENT), result);
    }
    ...
    public void testConstructJCRQueryWithDefaultSort() {
        ...
        // THEN
        assertEquals(String.format(AbstractJcrContainer.SELECT_TEMPLATE, MgnlNodeTypeNames.CONTENT) + AbstractJcrContainer.ORDER_BY + AbstractJcrContainer.SELECTOR_NAME + ".[" + colName2 + "]" + AbstractJcrContainer.ASCENDING_KEYWORD, result);
    }
