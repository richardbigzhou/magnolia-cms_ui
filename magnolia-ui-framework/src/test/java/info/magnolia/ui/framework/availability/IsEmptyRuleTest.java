...
/**
 * Tests for {@link info.magnolia.ui.framework.availability.IsDeletedRule}.
 */
public class IsEmptyRuleTest extends RepositoryTestCase {

    private IsEmptyRule rule;
    ...
    @Test
    public void testIsAvailableForItemThatIsEmpty() throws RepositoryException {
        // GIVEN
    ...
    @Test
    public void testIsAvailableForItemThatIsNotEmpty() throws RepositoryException {
        // GIVEN
        Node node = webSiteSession.getRootNode().addNode("node2", NodeTypes.Page.NAME);
        node.addNode("node3", NodeTypes.Page.NAME);
