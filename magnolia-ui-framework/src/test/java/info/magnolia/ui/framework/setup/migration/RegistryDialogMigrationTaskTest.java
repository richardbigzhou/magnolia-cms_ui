 ...
 */
public class RegistryDialogMigrationTaskTest extends RepositoryTestCase {
    ...
    protected List<ModuleDefinition> getModuleDefinitionsForTests() throws ModuleManagementException {
        final ModuleDefinition core = new BetwixtModuleDefinitionReader().readFromResource("/META-INF/magnolia/ui-framework.xml");
    ...
    public void testExecuteRemoveTmpPath() throws RepositoryException, TaskExecutionException {
        // GIVEN
        RegistryDialogMigrationTask task = new RegistryDialogMigrationTask("testModule");
    ...
    public void testExecuteCustomActionMigration() throws RepositoryException, TaskExecutionException {
        ...
        RegistryDialogMigrationTask task = new RegistryDialogMigrationTask("testModule", customActions);
