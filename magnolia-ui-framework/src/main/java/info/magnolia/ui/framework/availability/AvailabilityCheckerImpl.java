...
public class AvailabilityCheckerImpl implements AvailabilityChecker {
    ...
    /**
     * @deprecated since 5.3.9 instead of use {@link #AvailabilityCheckerImpl(info.magnolia.objectfactory.ComponentProvider, info.magnolia.ui.vaadin.integration.contentconnector.ContentConnector, info.magnolia.ui.framework.availability.shorthandrules.JcrNodesAllowedRule, info.magnolia.ui.framework.availability.shorthandrules.JcrPropertiesAllowedRule, info.magnolia.ui.framework.availability.shorthandrules.MultipleItemsAllowedRule, info.magnolia.ui.framework.availability.shorthandrules.JcrRootAllowedRule, info.magnolia.ui.framework.availability.shorthandrules.JcrNodeTypesAllowedRule, info.magnolia.ui.framework.availability.shorthandrules.AccessGrantedRule, info.magnolia.ui.framework.availability.shorthandrules.WritePermissionRequiredRule)}
     */
