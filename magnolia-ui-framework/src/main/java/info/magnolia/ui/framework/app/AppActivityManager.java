...
public class AppActivityManager extends ActivityManager {
    ...
    public AppActivityManager(ActivityMapper appActivityMapper, EventBus eventBus, AppLauncherLayoutManager appLauncherLayoutManager, AppController appController) {
