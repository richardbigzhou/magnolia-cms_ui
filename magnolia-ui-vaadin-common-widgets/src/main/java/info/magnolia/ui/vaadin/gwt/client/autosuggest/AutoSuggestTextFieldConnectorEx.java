 ...
 */
@Connect(value = AutoSuggestTextFieldEx.class, loadStyle = LoadStyle.EAGER)
public class AutoSuggestTextFieldConnectorEx extends TextFieldConnector {

    @Override
    public VAutoSuggestTextFieldEx getWidget() {
        return (VAutoSuggestTextFieldEx) super.getWidget();
    }
