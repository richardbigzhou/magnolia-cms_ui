 ...
 */
public class AutoSuggestTextFieldEx extends TextField {

    public AutoSuggestTextFieldEx() {
        super();
    }

    public AutoSuggestTextFieldEx(String caption) {
        super(caption);
    }

    public AutoSuggestTextFieldEx(Property dataSource) {
        super(dataSource);
    }

    public AutoSuggestTextFieldEx(String caption, Property dataSource) {
        super(caption, dataSource);
    }

    public AutoSuggestTextFieldEx(String caption, String value) {
        super(caption, value);
    }

    public AutoSuggestTextFieldEx(AutoSuggesterResult autoSuggesterResult) {
        super();
        setStateAccordingToAutoSuggesterResult(autoSuggesterResult);
    }

    public AutoSuggestTextFieldEx(String caption, AutoSuggesterResult autoSuggesterResult) {
        super(caption);
        setStateAccordingToAutoSuggesterResult(autoSuggesterResult);
    }

    public AutoSuggestTextFieldEx(Property dataSource, AutoSuggesterResult autoSuggesterResult) {
        super(dataSource);
        setStateAccordingToAutoSuggesterResult(autoSuggesterResult);
    }

    public AutoSuggestTextFieldEx(String caption, Property dataSource, AutoSuggesterResult autoSuggesterResult) {
        super(caption, dataSource);
        setStateAccordingToAutoSuggesterResult(autoSuggesterResult);
    }

    public AutoSuggestTextFieldEx(String caption, String value, AutoSuggesterResult autoSuggesterResult) {
        super(caption, value);
        setStateAccordingToAutoSuggesterResult(autoSuggesterResult);
    }
