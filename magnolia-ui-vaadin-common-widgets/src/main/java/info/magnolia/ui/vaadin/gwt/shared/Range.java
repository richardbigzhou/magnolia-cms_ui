 ...
 *
 */
package info.magnolia.ui.vaadin.gwt.shared;

import java.io.Serializable;

/**
 * Represents a span of integer numbers of the type [start, end), provides convenience factory methods and logical operations like intersection,
 * inclusion check etc.
 *
 * This is almost verbatim copy of Vaadin's Range class used for the implementation of the Grid component
 * (first introduced in Vaadin 7.4).
 */
public final class Range implements Serializable {
     ...
     *
     * @param start the start integer, inclusive
     ...
     *
     * @param integer the number to represent as a range
     ...
     * but not 5.
     *
     * @param start the start of the the range, inclusive
     ...
     *
     * @param start the first integer to include in the range
     * @param length the length of the resulting range
     ...
     *
     * @param integer an integer to test for presence in this range
     ...
     *
     * @param offset the number to offset by
     ...
     *
     * @param integer the integer at which to split the range into two
     ...
     *
     * @param length the length at which to split this range into two
     ...
     *
     * @param other the range to combine with this range
     * @return the combined range
     * @throws IllegalArgumentException if the two ranges aren't connected
     */
     ...
     *
     * @param startDelta the amount to expand by in the beginning of the range
     * @param endDelta the amount to expand by in the end of the range
     * @return an expanded range
     * @throws IllegalArgumentException if the new range would have <code>start &gt; end</code>
     */
     ...
     *
     * @param bounds the bounds that the returned range should be limited to
