...
public class SubAppDescriptorKeyGenerator extends AbstractAppKeyGenerator<SubAppDescriptor> {
    ...
    protected void keysFor(List<String> keys, SubAppDescriptor subAppDescriptor, AnnotatedElement el) {
        ...
        addKey(keys, false, APPS, appDescriptor.getName(), SUB_APPS, subAppDescriptor.getName(), fieldOrGetterName);
        addKey(keys, appDescriptor.getName(), subAppDescriptor.getName(), fieldOrGetterName); //deprecated
        /*
         ...
         */
        addKey(keys, appDescriptor.getName(), "app", fieldOrGetterName); //deprecated
    }
}
