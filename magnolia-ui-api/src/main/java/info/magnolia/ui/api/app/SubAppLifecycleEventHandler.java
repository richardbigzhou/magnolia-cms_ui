...
/**
 * Handles {@link SubAppLifecycleEvent}. Provides a stub {@link Adapter} implementation for the convenience purposes.
 */
public interface SubAppLifecycleEventHandler extends EventHandler {

    void onSubAppFocused(SubAppLifecycleEvent event);

    void onSubAppBlurred(SubAppLifecycleEvent event);
