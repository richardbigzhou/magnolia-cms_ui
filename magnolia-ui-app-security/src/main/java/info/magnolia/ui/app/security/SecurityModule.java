...
/**
 * Module class for the Security App. It creates the app and sub-apps, as well
 * as the dialogs.
 */
public class SecurityModule implements ModuleLifecycle {
    ...
    @Inject
    public SecurityModule(DialogDefinitionRegistry dialogDefinitionRegistry,
    ...
    public void securityApp(ContentAppBuilder app, UiConfig cfg) {
        ...
        app.label("Security")
                ...
                .subApps(
                                        ...
                                        cfg.workbenches
                                                ...
                                                .groupingItemType(
                                                        cfg.workbenches
                                                                ...
                                                                .icon("/.resources/icons/16/folders.gif"))
                                                .mainItemType(
                                                        cfg.workbenches
                                                                .itemType(
                                                                        NodeTypes.Group.NAME)
                                                                .icon("/.resources/icons/16/pawn_glass_yellow.gif"))
                                                .imageProvider(cipd)
                                                .columns(
                                                        cfg.columns
                                                                .property(
                                                        ...
                                                        cfg.columns
                                                                ...
                                                                .expandRatio(2),
                                                        cfg.columns
                                                                .column(new StatusColumnDefinition())
                                                                .name("status")
                                                                .label("Status")
                                                                .displayInDialog(
                                                                        false)
                                                                .formatterClass(
                                                                        StatusColumnFormatter.class)
                                                                .width(46),
                                                        cfg.columns
                                                                .column(new MetaDataColumnDefinition())
                                                                .name("moddate")
                                                                ...
                                                                .sections(
                                                                        cfg.actionbars
                                                                                .section(
                                                                                        "groupActions")
                                                                                .label("Groups")
                                                                                .groups(cfg.actionbars
                                                                                        .group("addActions")
                                                                                        .items(cfg.actionbars
                                                                                                .item("addGroup")
                                                                                                .label("New group")
                                                                                                .icon("icon-add-item")
                        ...
                        app.subApp("roles")
                                .subAppClass(SecurityRolesSubApp.class)
                                .workbench(
                                        cfg.workbenches
                                                .workbench()
                                                .workspace("userroles")
    ...
    protected ContentSubAppBuilder userSubApp(ContentAppBuilder app,
            UiConfig cfg, String name, String root) {
        // user
        ...
        return app
                .subApp(name)
                .subAppClass(SecurityUsersSubApp.class)
                .workbench(
                        cfg.workbenches
                                .workbench()
                                .workspace("users")
                                ...
                                .groupingItemType(
                                        cfg.workbenches
                                                .itemType(NodeTypes.Folder.NAME)
                                                .icon("/.resources/icons/16/folders.gif"))
                                // see MGNLPUR-77
                                .mainItemType(
                                        cfg.workbenches
                                                .itemType(NodeTypes.User.NAME)
                                                .icon("/.resources/icons/16/pawn_glass_yellow.gif"))
                                .imageProvider(cipd)
                                .columns(
                                        cfg.columns
                                                .column(new UserNameColumnDefinition())
                                                .name("name")
                                                .label("Name")
                                                .sortable(true)
                                                .propertyName("jcrName")
                                                .formatterClass(
                                                        UserNameColumnFormatter.class)
                                                .expandRatio(2),
                                        cfg.columns
                                                .property("title", "Full name")
                                                .sortable(true).expandRatio(2),
                                        cfg.columns.property("email", "Email")
    ...
    public void userDialog(DialogBuilder dialog, UiConfig cfg, boolean editMode) {
        ...
        AbstractFieldBuilder username = cfg.fields.text("jcrName")
                .label("User name").description("Define user name")
                .required(!editMode).readOnly(editMode);
        if (!editMode) {
            username.validator(cfg.validators.custom(
                    new UniqueUserIdValidatorDefinition()).errorMessage(
                    "User name already exists."));
        }

        GroupManagementFieldBuilder groups = new GroupManagementFieldBuilder(
                "groups");
        ...
        RoleManagementFieldBuilder roles = new RoleManagementFieldBuilder(
                "roles");
        ...
        dialog.form(
                cfg.forms
                        .form()
                        .description("Define the user information")
                        .tabs(cfg.forms
                                .tab("User")
                                .label("User info")
                                .fields(username,
                                        cfg.fields.password("pswd")
                                                .label("Password")
                                                .verification().encode(false), // we
                                                                               // handle
                                                                               // encoding
                                                                               // in
                                                                               // the
                                                                               // save
                                                                               // action
                                        (new EnabledFieldBuilder("enabled"))
                                                .label("Enabled"),
                                        cfg.fields.text("title").label(
                                                "Full name"),
                                        cfg.fields
                                                .text("email")
                                                .label("E-mail")
                                                .description(
                                                        "Please enter user's e-mail address."),
                                        cfg.fields
                                                .select("language")
                                                .label("Language")
                                                .options(
                                ...
                                cfg.forms.tab("Roles").label("Roles")
                                        .fields(roles))).actions(
                cfg.dialogs.action("commit").label("save changes")
                        .action(new SaveUserDialogActionDefinition()),
                cfg.dialogs.action("cancel").label("cancel")
                        .action(new CancelDialogActionDefinition()));
    }
    ...
    public void groupDialog(DialogBuilder dialog, UiConfig cfg, boolean editMode) {
        ...
        AbstractFieldBuilder groupName = cfg.fields.text("jcrName")
                .label("Group name").description("Define group name")
                .required(!editMode).readOnly(editMode);
        if (!editMode) {
            groupName.validator(cfg.validators.custom(
                    new UniqueGroupIdValidatorDefinition()).errorMessage(
        ...
        dialog.description("Define the group information")
                        ...
                        .tabs(cfg.forms
                                ...
                                .fields(groupName,
                                        ...
                                        cfg.fields
                                                ...
                                                .label("Description")
                                                .description(
                                                        "Detail description of the group")),
                                cfg.forms.tab("Groups").label("Groups")
                                        .fields(groups),
                                cfg.forms.tab("Roles").label("Roles")
                                        .fields(roles)))
                .actions(
                        cfg.dialogs.action("commit").label("save changes")
                                .action(new SaveGroupDialogActionDefinition()),
                        cfg.dialogs.action("cancel").label("cancel")
                                .action(new CancelDialogActionDefinition()));
    }
    ...
    public void roleDialog(DialogBuilder dialog, UiConfig cfg, boolean editMode) {
        ...
        AbstractFieldBuilder roleName = cfg.fields.text("jcrName")
                .label("Role name").description("Define unique role name")
                .required(!editMode).readOnly(editMode);
        if (!editMode) {
            roleName.validator(cfg.validators.custom(
                    new UniqueRoleIdValidatorDefinition()).errorMessage(
                ...
                .form(cfg.forms
                        ...
                        .tabs(cfg.forms
                                ...
                                cfg.forms
                                        ...
                                        .fields(cfg.fields.staticField(
                                                "placeholder").label(
                                                "Placeholder for ACL control"))))
                .actions(
                        cfg.dialogs.action("commit").label("save changes")
                                .action(new SaveRoleDialogActionDefinition()),
                        cfg.dialogs.action("cancel").label("cancel")
                                .action(new CancelDialogActionDefinition()));
    }
    ...
    public void start(ModuleLifecycleContext moduleLifecycleContext) {
        CodeConfigurationUtils.registerAnnotatedAppProviders(
                appDescriptorRegistry, this);
        CodeConfigurationUtils.registerAnnotatedDialogProviders(
                dialogDefinitionRegistry, this);
    }
