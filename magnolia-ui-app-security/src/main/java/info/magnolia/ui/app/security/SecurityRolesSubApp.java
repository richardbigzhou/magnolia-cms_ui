...
public class SecurityRolesSubApp extends BrowserSubApp {
    ...
    @Inject
    public SecurityRolesSubApp(final SubAppContext subAppContext, ContentSubAppView view, BrowserPresenter workbench, @Named(SubAppEventBusConfigurer.EVENT_BUS_NAME) EventBus subAppEventBus) {
