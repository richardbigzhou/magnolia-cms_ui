...
public class SecurityUsersSubApp extends BrowserSubApp {
    ...
    @Inject
    public SecurityUsersSubApp(final SubAppContext subAppContext, ContentSubAppView view, BrowserPresenter workbench, @Named(SubAppEventBus.NAME) EventBus subAppEventBus) {
