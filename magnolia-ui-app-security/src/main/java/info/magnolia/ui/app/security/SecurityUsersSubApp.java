...
public class SecurityUsersSubApp extends BrowserSubApp {
    ...
    @Inject
    public SecurityUsersSubApp(final SubAppContext subAppContext, WorkbenchSubAppView view, BrowserPresenter workbench, @Named(SubAppEventBusConfigurer.EVENT_BUS_NAME) EventBus subAppEventBus) {
