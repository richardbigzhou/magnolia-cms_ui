...
public class AboutPresenterTest {
    ...
    public void setUp() {
        ...
        ComponentsTestUtil.setInstance(LicenseFileExtractor.class, mock(LicenseFileExtractor.class));
        ...
        presenter = new AboutPresenter(view, serverConfiguration, properties, i18n);
    }
    ...
    public void startPopulatesViewWithDataSourceAndDoesntAddNullProperties() throws Exception {
        ...
        presenter = new AboutPresenter(fakeView, serverConfiguration, properties, i18n);
