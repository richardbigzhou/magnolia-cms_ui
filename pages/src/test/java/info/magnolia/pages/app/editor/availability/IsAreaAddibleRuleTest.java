...
/**
 * Tests for {@link IsAreaAddibleRule}.
 */
public class IsAreaAddibleRuleTest {

    private PageEditorPresenter presenter;
    private AreaElement element;
    private IsAreaAddibleRule rule;
    ...
    public void setUp() throws Exception {
        ...
        this.rule = new IsAreaAddibleRule(presenter);
    }

    @Test
    public void testAreaIsAddible() throws Exception {
        // GIVEN
        when(element.getAddible()).thenReturn(true);
    ...
    @Test
    public void testAreaIsNotAddible() throws Exception {
        // GIVEN
        when(element.getAddible()).thenReturn(false);
