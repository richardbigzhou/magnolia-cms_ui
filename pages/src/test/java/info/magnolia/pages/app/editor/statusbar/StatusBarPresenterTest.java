...
import info.magnolia.pages.app.editor.statusbar.definition.ConfiguredStatusBarDefinition;
...
/**
 * Tests for {@link StatusBarPresenter}.
 */
public class StatusBarPresenterTest {
    ...
    public void testExtensionLifecycle() throws Exception {
        // GIVEN
        subAppDescriptor.setStatusBar(createDefinition());


        this.presenter = new StatusBarPresenter(view, subAppContext, extensionFactory);
        ...
        // THEN
        verify(view, times(1)).addComponent(any(Component.class), any(Alignment.class));
    ...
    @Test
    public void testMissingStatusBarDefinition() throws Exception {
        // GIVEN
        this.presenter = new StatusBarPresenter(view, subAppContext, extensionFactory);
        ...
        // THEN
        verify(view, times(0)).addComponent(any(Component.class), any(Alignment.class));
    }

    private StatusBarDefinition createDefinition() {
        Map<String, ExtensionDefinition> extensions = new HashMap<String, ExtensionDefinition>();

        extensions.put("extension", new ExtensionDefinition() {
            @Override
        ...
        ConfiguredStatusBarDefinition definition = new ConfiguredStatusBarDefinition();
