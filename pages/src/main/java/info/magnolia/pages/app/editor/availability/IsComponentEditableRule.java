 ...
 */
public class IsComponentEditableRule extends AbstractElementAvailabilityRule<ComponentElement> {

    @Inject
    public IsComponentEditableRule(PageEditorPresenter pageEditorPresenter) {
