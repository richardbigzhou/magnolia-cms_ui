 ...
 */
public class IsComponentMovableRule extends AbstractElementAvailabilityRule<ComponentElement> {

    @Inject
    public IsComponentMovableRule(PageEditorPresenter pageEditorPresenter) {
        super(pageEditorPresenter, ComponentElement.class);
    }

    @Override
    protected boolean isAvailableForElement(ComponentElement element) {
        return element.getMoveable();
    }
}
