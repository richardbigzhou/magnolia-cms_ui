 ...
 */
public class IsAreaAddibleRule extends AbstractElementAvailabilityRule<AreaElement> {

    @Inject
    public IsAreaAddibleRule(PageEditorPresenter pageEditorPresenter) {
        super(pageEditorPresenter, AreaElement.class);
    }

    @Override
    protected boolean isAvailableForElement(AreaElement element) {
        return element.getAddible();
    }
}
