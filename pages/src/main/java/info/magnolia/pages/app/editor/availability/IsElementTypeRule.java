...
public class IsElementTypeRule extends AbstractAvailabilityRule {
    ...
    public IsElementTypeRule(IsElementTypeRuleDefinition definition, PageEditorPresenter pageEditorPresenter) {
    ...
    protected boolean isAvailableForItem(Object itemId) {
        return element != null && element.getClass().isAssignableFrom(definition.getElementType());
    }
}
