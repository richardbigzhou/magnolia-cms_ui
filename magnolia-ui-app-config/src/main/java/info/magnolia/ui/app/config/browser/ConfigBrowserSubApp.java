...
public class ConfigBrowserSubApp extends BrowserSubApp {
    ...
    @Inject
    public ConfigBrowserSubApp(final SubAppContext subAppContext, ContentSubAppView view, BrowserPresenter browser, @Named(SubAppEventBusConfigurer.EVENT_BUS_NAME) EventBus subAppEventBus) {
