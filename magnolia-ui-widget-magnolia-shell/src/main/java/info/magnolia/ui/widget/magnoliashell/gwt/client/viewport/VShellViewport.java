...
public class VShellViewport extends VPanelWithCurtain implements Container, ContainerResizedListener {
    ...
    public VShellViewport() {
        ...
        loadingPane.attachTo(this);
    }

    /*private class Test extends Element{
    ...
    private class LoadingPane{
       ...
       private final Element loadingModalityCurtain = DOM.createDiv();
        ...
        public LoadingPane(){
            super();
            //loadingIcon.getElement().getStyle().setProperty("marginTop", "10px");
        ...
        public void attachTo(Widget parent){
